...
public static class CatalogManagementTools
{
    ...
    public static async Task<string> CreateStoreProduct(
    ...
    public static async Task<string> UpdateStoreProduct(
        ICatalogCommandService service,
    ...
    public static async Task<string> RemoveStoreProduct(
        ICatalogCommandService service,
